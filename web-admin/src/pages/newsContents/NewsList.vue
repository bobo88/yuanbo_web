    ...
    <div class="common-content">
      <div class="clearfix common-tit">
        ...
        <div class="fixed-right-cont">
          <el-button type="primary" class="mr20" size="mini" @click="handleAdd">{{ $t('message.add') }}</el-button>
          <!-- 全新搜索体验 -->
     ...
     size="300px">
      <div class="search-cont">
        ...
        <div class="mb10">
          ...
          <el-input clearable size="mini" class="w150 mb5"  v-model="id"></el-input>
        </div>
        <div class="mb10">
          <span class="tit">{{ $t('message.NewsType') }}:</span>
          <el-select clearable size="mini" class="w150 mb5" v-model="type">
        ...
        <div class="mb10">
          <span class="tit">{{ $t('message.NewsLanguage') }}:</span>
          <el-select clearable size="mini" class="w150 mb5" v-model="language">
            <el-option key="0" label="中文" value="cn"></el-option>
            <el-option key="1" label="English" value="en"></el-option>
          </el-select>
        </div>
        <div class="mb10">
          <el-button size="mini" @click="search" type="primary" plain class="mb10">Search</el-button>
        </div>
      </div>
    </el-drawer>
  </div>
...
export default {
  ...
  components: {
    ...
    handleAdd (index, item) {
      this.$router.push({name: 'OprateNews', query: {type: 'add'}});
    },
    // 编辑
    handleEdit (index, item) {
      this.$router.push({name: 'OprateNews', query: {type: 'edit', id: item.id}});
    },
    // 删除
    async handleDelete () {
